...
const Display = (props) => {
  ...
  return (
    <div>
      <h2 className="maintitle">Popular Recipies</h2>
                ...
                <div>
                  ...
                  <div className="cusine">
                    <input
                      ...
                      id="ame"
                    />
                    <label style={{ cursor: "pointer" }} htmlFor="ame">
                      American
                    </label>
                  </div>
                  <div className="cusine">
                    <input
                      ...
                      id="car"
                    />
                    <label style={{ cursor: "pointer" }} htmlFor="car">
                      Caribbean
                    </label>
                  </div>
                  <div className="cusine">
                    <input
                      ...
                      id="chi"
                    />
                    <label style={{ cursor: "pointer" }} htmlFor="chi">
                      Chinese
                    </label>
                  </div>
                  <div className="cusine">
                    <input
                      ...
                      id="sou"
                    />
                    <label style={{ cursor: "pointer" }} htmlFor="sou">
                      Southern
                    </label>
                  </div>
                </div>
                ...
                <div>
                  <div className="meal">
                    <input
                      ...
                      name="mealType"
                    />
                    <label style={{ cursor: "pointer" }} htmlFor="sidedish">
                      Side Dish
                    </label>
                  </div>
                  <div className="meal">
                    <input
                      ...
                      name="mealType"
                    />
                    <label style={{ cursor: "pointer" }} htmlFor="dessert">
                      Dessert
                    </label>
                  </div>
                  <div className="meal">
                    <input
                      ...
                      name="mealType"
                    />
                    <label style={{ cursor: "pointer" }} htmlFor="breakfast">
                      Breakfast
                    </label>
                  </div>
                  <div className="meal">
                    <input
                      ...
                      name="mealType"
                    />
                    <label style={{ cursor: "pointer" }} htmlFor="snack">
                      Snack
                    </label>
                  </div>
                </div>
                ...
                <div>
                  <div className="readytime">
                    <input
                      ...
                      name="readyTime"
                    />
                    <label style={{ cursor: "pointer" }} htmlFor="40">
                      40
                    </label>
                  </div>
                  <div className="readytime">
                    <input
                      ...
                      name="readyTime"
                    />
                    <label style={{ cursor: "pointer" }} htmlFor="60">
                      60
                    </label>
                  </div>
                  <div className="readytime">
                    <input
                      ...
                      name="readyTime"
                    />
                    <label style={{ cursor: "pointer" }} htmlFor="100">
                      100
                    </label>
                  </div>
                  <div className="readytime">
                    <input
                      ...
                      name="readyTime"
                    />
                    <label style={{ cursor: "pointer" }} htmlFor="150">
                      150
                    </label>
                  </div>
                </div>
